...
//	$base1 = 'pay_acept';
	...
	$query = "SELECT * FROM $base order by lasname_field";
	...
	*/
	...
	for ($i=4;$i<$nj;$i++)
		{
		if ($i != 2&&$i != 3&&$i != 6&&$i != 7&&$i != 10&&$i !=11&&$i != 12&&$i != 13&&$i != 14&&$i != 15)
		{
			$k=$i-1;
	...
	Echo("<tr>");
		...
		echo("<td>
		<tr>
		<td><td><b>http://profi-course.org.ua</b></td></td>
		");

		for ($j=1;$j<$nj;$j++)
		{
		if ($j != 21&&$j != 3&&$j != 9&&$j != 10&&$j != 11&&$j != 12 &&$j != 13&&$j != 14)
		{
		$n = $name[$j];
...
//	Echo "<span style = 'color: #000000'>".$titles[$j]."</span>";
	echo " <font color = '#000000'>". $data ."</font></td>" ;
		}
		}
		echo("</td>
