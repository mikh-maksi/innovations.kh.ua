<?	
	$filename = 'course_course';
	$actiondesc = 'названий курсов';

	require('../config.php');

	require ("data/data_".$filename.".php"); //Позже - должно браться из бд. Таблица - Id/имя/название/обяз/тип
	...
	echo("
		...
		<tr><td colspan = 2 align = center><b><a href = '".$filename.".php'>Вернуться на страницу ".$actiondesc."</a></b></td>
	</table>");
