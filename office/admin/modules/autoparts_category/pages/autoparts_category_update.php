<?	require('../config.php');
	...
	require('data/data_autoparts_category.php'); //Позже - должно браться из бд. Таблица - Id/имя/название/обяз/тип
	...
	echo("
		...
		<tr><td colspan = 2 align = center><b><a href = 'autoparts_category.php'>Вернуться на страницу изм. атрибутов</a></b></td>
	</table>");
