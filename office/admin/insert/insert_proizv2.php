<?php
	...
	if ($fp) 
		...
		$query = 'INSERT INTO proizv2 ( year, prom, karier, pererob, harch, textil, tree, koks, him, farm, plast, metal, mashin, energy
) VALUES ("'.$out[0].'",'.$out[1].','.$out[2].','.$out[3].','.$out[4].','.$out[5].','.$out[6].','.$out[7].','.$out[8].','.$out[9].','.$out[10].','.$out[11].','.$out[12].','.$out[13].')';
		echo $query;
